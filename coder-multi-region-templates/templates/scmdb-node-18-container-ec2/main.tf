...
resource "coder_agent" "coder" {
  ...
  startup_script         = <<-EOT
    ...
    # install client packages for mariadb & mongodb helper containers
    sudo apt-get update
    sudo apt-get install -y mariadb-client
    curl -Lo ~/mongodb-mongosh.deb https://downloads.mongodb.com/compass/mongodb-mongosh_1.10.6_amd64.deb
    sudo apt-get install -y ~/mongodb-mongosh.deb
